...
# Page configuration
st.set_page_config(
    page_title="RBAC Database Setup",
    page_icon="🗄️",
    layout="wide"
)

# Title and description
st.title("Snowflake RBAC Database Setup Example")
st.markdown("### RBAC Structure: Database, Schema, Access Roles, and Functional Roles")
st.markdown("---")
